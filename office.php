...
$sql = "SELECT name, IMG AS 'img_link', city, street, ZIP, office.ID AS ID
FROM office
INNER JOIN location
ON office.fk_location = location.ID ";
			  ...
			  <img class="card-img-top" src="<?php echo $row['img_link'] ?>" alt="Card image cap">
				  ...
				  <div class="card-body">
				    ...
				    <ul class="list-unstyled">
				    	<li><em>Model: </em><?php echo $row['name'] ?></li>
				    	<li><em>Latitude: </em><?php echo $row['city'] ?></li>
				    	<li><em>Longitude: </em><?php echo $row['street'] ?></li>
				    	<li><em>Longitude: </em><?php echo $row['ZIP'] ?></li>
				    	
				    	<li><a href="rent.php?fleet=<?php echo $row['ID'] ?>" class="btn btn-primary">Check out our fleet</a></li>
				    </ul>
				  </div>
				</div>
				<?php
